...
av = nrrdread('annotation_100.nrrd');
st = loadStructureTree('structure_tree_safe_2017.csv');
...
writeNPY(avI, 'annotation_volume_100um_by_index.npy')

%% Write NPY for intensity template
tv = nrrdread('average_template_100.nrrd');
fprintf('Finished reading\n');
%tv = permute(tv, [2 1 3]);
writeNPY(tv, 'template_volume_100um.npy');
...
save allen_ccf_colormap_100um.mat cmap